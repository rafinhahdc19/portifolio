        ...
        <>
            <div className="flex justify-center mb-3">
                <div className="border justify-center p-3 border-[#1DDA52] rounded-2xl">
                    ...
                    />
                    <h1 className="font-bold md:text-2xl text-xl mb-2">{title}</h1>
                    <h2 className="font-medium md:text-xl text-xl mb-2">{desc}</h2>
                    <Link href={link} className="flex md:text-xl text-lg mb-2 text-[#4593F0]">
